...
YELLOW_LOWER = np.array([20, 28, 118])
YELLOW_UPPER = np.array([30, 170, 253])

# Blue line, right side
BLUE_LOWER = np.array([95, 11, 64])
BLUE_UPPER = np.array([113, 229, 251])

# -----------------------------
# Line detection settings
# -----------------------------

LOOKAHEAD_Y = int(FRAME_H * 0.75)   # where to look for the lines
BAND_HEIGHT = 40                    # thickness of horizontal band
MIN_PIXELS = 30                     # minimum pixels needed to trust a line
